...
Data Cleaning: Handling missing pricing or specification data, and formatting columns.

Correlation Analysis: Checking how strongly features like VRAM size or Clock Speed correlate with final pricing.

Distribution Analysis: Examining the distribution of TDP (power draw) across different performance tiers.
